...
const ProductTable = ({ products, onEdit, onSave, onDelete, isSaving }: ProductTableProps) => {
            ...
            <div key={product.id} className="p-4">
              <div className="flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">{product.brand || product.category?.name}</p>
