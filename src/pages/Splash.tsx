    ...
    <div className="relative flex h-screen w-full flex-col items-center justify-center bg-background overflow-hidden">
      ...
      >
        <div className="relative">
          ...
          <span className="relative material-symbols-outlined brain-gradient-text text-[80px]">bolt</span>
        </div>

        <div className="text-center">
          <h1 className="font-display text-5xl font-bold tracking-wider brain-gradient-text mb-2">BRAINHUB</h1>
          <p className="text-muted-foreground text-sm tracking-[0.2em] uppercase">Future Tech & Gadgets</p>
        </div>
      </motion.div>
