      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-12 lg:px-20">
        ...
        >
          ...
          <button onClick={() => navigate("/")} className="flex items-center gap-2 mb-10">
            ...
            <span className="font-display text-2xl font-bold">ROOTHUB</span>
          </button>
          ...
          <div className="flex gap-4 mb-8">
            <button
              ...
              className={`flex-1 py-3 rounded-lg font-medium transition-all ${
                activeTab === "signin" ? "bg-primary text-primary-foreground" : "bg-surface text-muted-foreground"
              }`}
            >
              Sign In
            </button>
            <button
              ...
              className={`flex-1 py-3 rounded-lg font-medium transition-all ${
                activeTab === "signup" ? "bg-primary text-primary-foreground" : "bg-surface text-muted-foreground"
              }`}
            >
              Sign Up
            </button>
      ...
      <div className="hidden lg:block flex-1 bg-gradient-to-br from-surface to-card p-12">
        <div className="h-full rounded-3xl overflow-hidden relative">
          ...
          <div className="absolute bottom-10 left-10 right-10">
            <h2 className="font-display text-3xl font-bold text-foreground mb-2">Premium Sound Experience</h2>
            <p className="text-muted-foreground">Discover the finest audio equipment curated for audiophiles.</p>
          </div>
        </div>
      </div>
    </div>
